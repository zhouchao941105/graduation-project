    ...
    return angular.module('GridService', [])
        .factory('gridHelper', [
            ...
            function ($timeout, q, http) {
                return {
                    extendGridScope: function (scope, defultQueryPath, defaultOrder, filterFixed) {
                        ...
                        scope.queryData = function (pageIdx) {
                            ...
                            http.post(scope.queryPath, {
                                ...
                                filter: scope.isAdvancedQueryVisable?scope.filterPreNow:{},
                                order: scope.order,
                        ...
                        scope.clearFilter = function (defaultFilter) {
                            scope.filterKey.Pre = '';
                            scope.filterKey.Now = '';
                            scope.filterPreNow = defaultFilter||{};
                            scope.filter = {};
                        };
