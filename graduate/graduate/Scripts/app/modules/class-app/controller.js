define([
    "angular",
    "components/uploadEas/directive",
    "services/commonService",
    "modules/class-management-app/services",
    "services/dialogService",
    "components/single-popup-with-progress/directive",
    "components/paging/directive",
    "commonDirective",
    "services/current-user-service",
], function (angular) {
    return angular.module("ClassManagementApp.controller", ["Components.uploadEas", "Common.services", "ClassManagementApp.services", 'brantwills.paging', "CommonDirective", "Components.singlePopupWithProgress", "CommonFilter", "Dialog.services", "service.currentUser"])
